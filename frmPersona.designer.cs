    ...
    partial class frmPersona
    {
        ...
        private void InitializeComponent()
        {
           ...
           // this.lstPersonas.SelectedIndexChanged += new System.EventHandler(this.lstPersonas_SelectedIndexChanged);
            ...
            // insert o update
            /*
             * 1. Copiar los datos de la persona en una instancia de la clase persona y agregarlos en la lista de la derecha (APELLIDO, NOMBRE)
             * Persona persona = new Persona()
             * persona.apellido = txtapellido.Text; 
             * 2. Generar una conexion a la db con el OleDbConnection
             * 3. Generar el insert de SQL y pasarselo al OleDbCommand
             * 4. Guardar los datos en la db
             * 5. Limpiar los campos y posterior dehabilitar
             * 6. Completar  los pasos anteriores para una conexion SQL
             */
